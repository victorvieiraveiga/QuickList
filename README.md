...
Aplicativo Mobile Desenvolvido em Swift. Trata-se de uma Todo List com persistencia utilizando banco de dados [REALM](https://realm.io/). 
Utilizei o repositório [CHAMALEON](https://github.com/wowansm/Chameleon) para criar cores aleatorias de backgrounds das categorias e criar cores gradientes na lista de tarefas.
